...
- **Certificate:** one ACM certificate for the shared ALB covering `jugueria.jhanantezana.com`, `*.jugueria…`, and `*.test.jugueria…` (a single wildcard level does not cover `api.test.…`).
